...
;; A decentralized fitness platform for tracking workouts, challenges, and rewards
;; Built on Stacks blockchain to provide transparent and secure fitness tracking

;; ========== Error Constants ==========
(define-constant ERR-UNAUTHORIZED (err u100))
(define-constant ERR-USER-EXISTS (err u101))
(define-constant ERR-USER-MISSING (err u102))
(define-constant ERR-CHALLENGE-UNAVAILABLE (err u103))
(define-constant ERR-CHALLENGE-DUPLICATE (err u104))
(define-constant ERR-CHALLENGE-EXPIRED (err u105))
(define-constant ERR-CHALLENGE-TOO-EARLY (err u106))
(define-constant ERR-INVALID-WORKOUT (err u107))
(define-constant ERR-DUPLICATE-WORKOUT (err u108))
(define-constant ERR-INVALID-INPUT (err u109))
(define-constant ERR-NOT-CHALLENGE-OWNER (err u110))
